...
export class LazyImgDirective {
  constructor({ nativeElement }: ElementRef) {
     ...
     */
      console.warn(
        'The Browser does not support the loading attribute on images. Consider using IntersectionObserver (https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API)'
      );
    }
  }
}
